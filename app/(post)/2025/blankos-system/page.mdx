...
It kicked off with Neovim. I thought I was just building an editor, but it turned into something else. VS Code hides a lot of complexity behind slick interfaces. You get the power, but not the understanding. Neovim gives you both if you're willing to earn it. Building it piece by piece showed me which features mattered, which didn't, and which I'd been taking for granted. <CopyPrompt id="neovim" />
...
Git came next. I held off on installing LazyGit to force myself into the CLI. I thought it would slow me down. Instead, it made me better. Now when something breaks, I know how to fix it. I don't need a safety net, just a terminal and time. <CopyPrompt id="git" />

Then I found tmux, and everything changed. Running tmux inside Ghostty turned my terminal into a cockpit. I can split panes, resize windows, and move between projects without touching the mouse. It feels mechanical in the best way, like working a control panel that only I understand. Once it clicks, you can't go back. <CopyPrompt id="tmux" />

Outside the terminal, I run AeroSpace to tile windows and keep my fingers glued to the keyboard. Mouse is lava. Staying still keeps my focus sharp. <CopyPrompt id="aerospace" />
