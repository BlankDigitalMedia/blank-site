...
I help small businesses in Southwest Michigan use technology without the complexity or the big agency price tag. Here's what I do:
...
<div className="my-8 p-6 bg-accent/50 border border-border rounded-lg">
  <a href="https://cal.com/daveblank" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-3 bg-foreground text-background rounded-lg font-medium hover:opacity-90 transition-opacity">
